...
class CompraDetalle(models.Model):
    ...
    precio_por_mayor = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)
    ...
    margen_por_mayor = models.DecimalField(max_digits=5, decimal_places=2, default=0.00)
