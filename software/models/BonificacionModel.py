...
class ReglaBonificacion(models.Model):
    ...
    porcentaje_lista = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, help_text="Porcentaje para Precio Lista (ej. 2.00)")
    porcentaje_cash = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, help_text="Porcentaje para Precio Cash (ej. 1.50)")
    porcentaje_mayor = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, help_text="Porcentaje para Precio Mayor (ej. 1.00)")
