...
urlpatterns = [
    ...
    path('reportes/articulos-vendidos/', reportes.reporte_articulos_vendidos, name='reporte_articulos_vendidos'),
    path('reportes/articulos-vendidos/api/listar/', reportes.api_listar_reporte_articulos, name='api_listar_reporte_articulos'),
